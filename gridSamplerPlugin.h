...
private:
    ...
    GridSamplerInterpolation mInterpolationMode = GridSamplerInterpolation::Bilinear;
    GridSamplerPadding mPaddingMode = GridSamplerPadding::Zeros;
    bool mAlignCorners = false;
    std::string mNamespace;
};

class GridSamplerPluginCreator : public IPluginCreator
{
public:
